...
import magic_circle_img from './images/magic_circle.png'
import magic_circle_vdo from './images/MagicCircle.mp4'
import bucketlistmaker from './images/bucketlistmaker.png'
...
const texts = [
  ...
  },
  {
    ...
    thumbnail : magic_circle_img,
    video : magic_circle_vdo
  },
  {
    title : 'バケツリストメーカー',
    cardText : 'バケツリスト作成アプリ',
    modalText : `バケツリストというTodoリストのようなものを簡単に作成できるWebアプリです。
                達成度合いがゲージでわかる他、ツイートすることで達成のモチベーションを上げられます。`,
    thumbnail : bucketlistmaker,
    image : bucketlistmaker,
    linkName : 'Link',
    link : 'http://bucketlistmaker.net/'
  }
];

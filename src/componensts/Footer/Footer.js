...
const Footer = () => {
  return (
    <div className='footer' id='link'>
      ...
      <a href='https://www.instagram.com/hayato42399/' target="_blank" rel='noopener noreferrer'><i className="fab fa-instagram fa-2x mx-3 mt-3 icon"></i></a>
